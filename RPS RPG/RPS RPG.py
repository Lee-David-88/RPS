...
def allocate_stats(character):
    ...
    while setting_up:
        ...
        options = input("Would you like to put in points for Hp or Attack (Enter Hp or Attack or Press x to exit): ").capitalize().strip()
        if options == "Hp":
            allocate_hp = int(input("How many points would you like to put into your Hp (Current Points:" + str(stat_points) + "): "))
            ...
            allocate_attack = int(
                input("How many points would you like to put into your attack (Current Points: " + str(stat_points) + "): "))
